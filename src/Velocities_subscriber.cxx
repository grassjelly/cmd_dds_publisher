...
{
    ros::NodeHandle nh;
    ros::Publisher cmd_vel_pub = nh.advertise<geometry_msgs::Twist>("cmd_vel_dds", 1000);
    ...
    reader_listener->cmd_vel_publisher = cmd_vel_pub;
...
{
    ros::init(argc, argv, "cmd_vel_dds_publisher");
